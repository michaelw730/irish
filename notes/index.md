...
[vocab.csv](vocab.csv#Family+Basic)
...
[vocab.csv](vocab.csv#Family+Introducting)
...
* [Numbers - Counting things](vocab.csv#Numbers)
...
[vocab.csv](vocab.csv#Expressing+Opinions)
...
[vocab.csv](vocab.csv#Where+you+are+going)
...
[giving-order.csv](giving-orders.csv)
...
[vocab.csv](vocab.csv#Giving+orders)
...
Mo and the other words that denote possession are never stressed in everyday speech. You add certain endings in order to add emphasis ..sa

The nouns following the personal numbers are usually in the genitive plural (although some of the nouns look exactly as they do in the nominative singular).  One last thing to remember: words beginning with a consonant take a séimhiú after beirt.
...
| a     | his     |         | a iníon      |             |             | a bhean |        |             |           |
| a     | her     |         |              |             | a hathair   |         | a fear |             |           |
| ár    | our     |         |              |             | ár n-athair |         |        | ár bpáistí  |           |
| bhur  | your    |         | bhur n-iníon |             |             |         |        | bhur gclann |           |
| a     | their   |         |              |             | a n-athair  |         |        | a bpáistí   |           |
...
[vocab.csv](vocab.csv#What+you+did)
...
[vocab.csv](vocab.csv#Taking+your+leave)
...
from `Tá mé tuirseach.`

[vocab.csv](vocab.csv#Daily+routine)
